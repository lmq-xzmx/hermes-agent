...
> **实现状态**: 🚧 ~75% (2026-05-02 核实)
>
> 已实现: GuidanceEngine (后端)、GuidanceModal、TourGuide.vue、useGuidance composable
>
> 未实现 (5项): 引导状态持久化、工作流/笔记本引导 Tour、前端触发点连接
>
> 📝 核实说明: CoachMark.js 在 web/js/components (旧版)，新版 Vue 组件仅有 GuidanceModal
